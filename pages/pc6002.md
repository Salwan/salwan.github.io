...
The color of the 4 horizontal-pixels is determined by the combination of both ADR and ATR bytes for that pixels. ATR is the high byte and ADR is the low byte:
